...
class OkxDex {
    ...
    async run(chain, fromToken, toToken) {
        ...
        if (fromTokenUpperCase === 'ETH' || fromTokenUpperCase === 'MATIC' || fromTokenUpperCase === 'BNB' || fromToken === 'AVAX') {
            ...
            await p.locator('//*[@id="dex_right_part"]/div[1]/div[2]/div[1]/div[1]/div[2]/div/div[2]/div[1]/input[2]').fill((balance * 0.8).toFixed(5));
        }
        else {
            console.log('all-in');
            await p.waitForTimeout(2000);
